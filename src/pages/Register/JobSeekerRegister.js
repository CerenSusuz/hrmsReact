...
export default function JobSeekerRegister() {
    ...
    const schema = Yup.object({
        ...
        yearOfBirth: Yup.number().required("Zorunlu alan *"),
    });
            ...
            <Modal size='small'
                ...
                trigger={
                    <Button animated color='blue'>
                        <Button.Content visible >İş Arayan Kayıt Ekranı</Button.Content>
                ...
                <Modal.Actions>
                    ...
                    >
                        <Form className="ui form">
                            ...
                            <KodlamaioTextInput name="yearOfBirth" placeholder="Doğum Yılı:" />
                            <Button
                                type='submit'
